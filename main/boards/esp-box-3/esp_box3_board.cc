...
/*
 * ESP-BOX-3 板级装配：初始化 I2C/SPI、ILI9341 LCD、音频 codec、按键和显示实现，
 * 再通过 Board 接口把这些单例外设提供给 Application。
 */

// ILI9341 厂商扩展初始化序列，包含电源、Gamma、像素格式和开屏命令。
